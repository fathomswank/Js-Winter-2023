...
let sortedArray = arr3.join(' ').toLowerCase().split(' ');
let firstOccurence = sortedArray.indexOf('baseball');

if(sortedArray.indexOf('baseball') !== sortedArray.lastIndexOf('baseball')){
    arr3Result = sortedArray.indexOf('baseball' , firstOccurence + 1);
} else if (sortedArray.indexOf('baseball') === sortedArray.lastIndexOf('baseball')) {
    arr3Result = -1;
}
...
// I know that you wanted us to use locale compare for this question but I found it easier to do it this way.
